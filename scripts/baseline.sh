...
python3 -m main --name baseline_vanilla --min_points 1000 --learning_rate 1e-4 --epochs 100 --batch_size 32 --data_dir ../data/MpalaForestGEO_LasClippedtoTreePolygons --label_path labels.csv --top_species 5